...
const GamingStats = () => {
  const stats = [
    {
      icon: <FaGamepad className="text-5xl mx-auto mb-4 text-teal-300" />,
      title: "Games Played",
      value: "1,245",
    },
    {
      icon: <FaTrophy className="text-5xl mx-auto mb-4 text-teal-300" />,
      title: "Trophies Won",
      value: "527",
    },
    {
      icon: <FaUserFriends className="text-5xl mx-auto mb-4 text-teal-300" />,
      title: "Team Members",
      value: "32",
    },
    {
      icon: <FaClock className="text-5xl mx-auto mb-4 text-teal-300" />,
      title: "Hours Played",
      value: "4,532",
    },
  ];
        ...
        {stats.map((stat, index) => (
          ...
          >
            ...
            <p className="text-3xl font-extrabold mt-2">
              {stat.value} <span className="text-teal-300">+</span>
            </p>
          </motion.div>
        ))}
      </div>
